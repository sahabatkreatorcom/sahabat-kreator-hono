...
export function PlatformSettingsPanel({
  ...
  // Platform yang punya field khusus di adapter
  const hasSpecial = (platform: string) =>
    [
      "tiktok",
      "youtube",
      "pinterest",
    ...
    <div className="card p-4">
      ...
      <div className="space-y-2">
        {selected.map((account) => {
          ...
          const showSpecial = hasSpecial(account.platform);
            ...
            >
              ...
              >
                <span className="flex items-center gap-2 font-medium text-xs">
                  ...
                  {(s.firstComment || showSpecial) && s.firstComment ? (
                    <span className="text-[10px] text-[var(--accent-gold)]">• FC</span>
                  ) : null}
                </span>
                <ChevronDown
                  className={cn(
              ...
              {isOpen && (
                <div className="space-y-3 border-[var(--border-light)] border-t p-3">
                  ...
                  {/* First comment — didukung IG/FB/TikTok (diposting sebagai komentar pertama) */}
                  {["instagram", "instagram_standalone", "facebook", "tiktok"].includes(
                    account.platform,
                  ) && (
                    <div className="space-y-1.5">
